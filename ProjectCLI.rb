...
food_choice = gets.chomp 
  ...
  if food_choice == "Thai"
     puts "What would you like to order from Thai Cuisine? Please put verbatim: Satay chicken or Pad-Thai?".cyan
        thai = gets.chomp 
      ...
      puts "Welcome to China Dynasty, what would you like to order? Please put verbatim: Sushi or Sticky Rice?".cyan
        chinese = gets.chomp 
        if chinese == "Sushi"
   ...
   puts "Hi! What would you like to order from Bertucci's ? Please put verbatim: Pizza or Pasta".cyan
    italian = gets.chomp 
    if italian == "Pizza"
     puts "Awesome, enjoy!"
    elsif italian == "Pasta"
     ...
     puts "Welcome to Chipotle! Can we take your order? Please put verbatim: Chicken Tacos or Veggie Burrito".cyan
     mexican = gets.chomp 
     ...
     puts "Good choice! MMmm Veggie!"
       ...
       puts "Welcome to MacDonalds! Our specials today are: Hamburger and Chicken Nuggets.".cyan
       fastfood = gets.chomp 
       if fastfood == "Hamburger"
       puts "Good choice! Here you go!"
       elsif fastfood == "Chicken Nuggets!"
